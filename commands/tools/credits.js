...
module.exports = {
  ...
  execute(message, args) {
    ...
    var luke = message.client.fetchUser("305771483865546752").then(luke => {
    var santiago = message.client.fetchUser("391984806638125066").then(santiago => {
    var vampy = message.client.fetchUser("330528293843632130").then(vampy => {
